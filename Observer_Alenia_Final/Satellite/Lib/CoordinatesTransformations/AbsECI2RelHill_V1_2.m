function deputy_rel_LVLH = AbsECI2RelHill_V1_2(satellites_iner_ECI, mi)

%   AbsECI2RelHill_V1_2.m
...
%   frame), relatively to a chief satellite, whose position and velocity must be the first six components of the input "satellites_iner_ECI"
%
%   INPUT
...
%
%   20191113 V1_2:
%   - The vector is rotated to chief's LVLH rather than the single deputy's LVLH
