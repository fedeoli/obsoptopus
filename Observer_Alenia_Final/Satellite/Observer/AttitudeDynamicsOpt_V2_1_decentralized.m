...
%Attitude Quaternion Dynamics as in Mahony 10.1109/TAC.2008.923738
...
%omega_Body2ECI_Body
%As in Challa, leave the bias from GyrosTemp!?
%GyrosTemp = w(5:7);
% dq = 0.5*[0, 0,-GyrosTemp(3), GyrosTemp(2), GyrosTemp(1); 
%                GyrosTemp(3),0,-GyrosTemp(1),GyrosTemp(2);
%                 -GyrosTemp(2),GyrosTemp(1),0,GyrosTemp(3);
%                 -GyrosTemp(1),-GyrosTemp(2),-GyrosTemp(3),0]*q_ECI2Body;
