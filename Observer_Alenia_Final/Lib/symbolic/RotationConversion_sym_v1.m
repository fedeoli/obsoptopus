function OUTPUT = RotationConversion_sym_v1(CONVERSION, input)
...
switch INPUT_TYPE
    case 'DCM'
        ...
        DCM_flag=0;
        for ii=1:N
            perturbed(:,:,ii)=abs(input(:,:,ii)*transpose(input(:,:,ii))-eye(3)); %perturbed array shows difference between DCM*DCM' and I
