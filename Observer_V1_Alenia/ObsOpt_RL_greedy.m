...
function RL = ObsOpt_RL_greedy(Nsearch)
    ...
    for i=1:RL.S.Nsearch
        ...
        [DynOpt, params] = ObsOpt_RL_v2(struct,RL);
        
        %%% normalise eigenvaules %%%
        max_eig = max(DynOpt.dtheta_eig_story_min);
        DynOpt.dtheta_eig_min_normalised = (max_eig - DynOpt.dtheta_eig_story_min)/max_eig;
        ...
        %%% store reward %%
        current_reward = trapz(RL.S.DynOpt(i).dtheta_eig_story_min);
