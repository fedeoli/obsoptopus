...
%     DynOpt.Rtheta = eul2rotm(DynOpt.RPYbetweenMagSensors');
%     DynOpt.Rtheta = eye(3);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    DynOpt.A = jacobian(DynOpt.f,DynOpt.X);    
    DynOpt.H = jacobian(DynOpt.h,DynOpt.X); 
    
    DynOpt.Asym = symfun(DynOpt.A,symarray);
    DynOpt.Hsym = symfun(DynOpt.H,symarray);
