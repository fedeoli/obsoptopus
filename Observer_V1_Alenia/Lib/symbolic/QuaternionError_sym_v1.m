function q_err = QuaternionError_sym_v1(q1, q2)
...
q_err_rior = [q_ref_rior(4) q_ref_rior(3) -q_ref_rior(2) -q_ref_rior(1);
              ...
              q_ref_rior(1) q_ref_rior(2) q_ref_rior(3) q_ref_rior(4)]*transpose(q_rior);

q_err = [q_err_rior(4), transpose(q_err_rior(1:3))];
