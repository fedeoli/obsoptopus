 function [dw]  = AttitudeDynamicsOpt_V1_1_decentralized_back(w, params,ith_satellite,k_microstep)
...
vect_r_chief = Agent(1).xHatUKF(1:3,ObserverTest.attitude_u_backIntime_index+1);
vect_v_chief =Agent(1).xHatUKF(4:6,ObserverTest.attitude_u_backIntime_index+1);
...
vect_r =  Agent(ith_satellite).xHatUKF(1:3,ObserverTest.attitude_u_backIntime_index+1); 
vect_v = Agent(ith_satellite).xHatUKF(4:6,ObserverTest.attitude_u_backIntime_index+1);
...
tau = reshape(ObserverTest.tau(:,ObserverTest.attitude_u_backIntime_index),3,ObserverTest.Nagents);
