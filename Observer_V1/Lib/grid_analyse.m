...
%             save(final_path)
            ...
            delta_init_window = window_interval(1)-window_step;
            delta_init_sample = sample_interval(1)-sample_step;
            row = (counter_window-delta_init_window)/window_step;
            column = (counter_sample-delta_init_sample)/sample_step;
