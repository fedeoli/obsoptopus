%% cost function
function Jtot = cost_function_v1(x,params)
...
for j=1:n_iter
    ...
    if(DynOpt.ForwardOptimization ~= 1) %backward        
        ...
        [DynOpt.buf_dyhat_temp, Yhat] = DynOpt.get_measure(X,j,1,DynOpt.buf_dyhat_temp,params);
